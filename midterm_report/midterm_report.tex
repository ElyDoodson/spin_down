...
It was shown in \cite{Garraffo_2018} that, when accounting for the breaking due to these magnetic winds and AM loss, this bimodal population could be seen with an evolved simulation of stars.
This was an analytical approach to the problem, however, with a wealth of new data from Kepler, K2 and TESS, this has provided the opportunity to approach gyrochronology from a more data driven approach and form an even greater understanding of the parameters that contrain such systems and how they will affect(effect?) the afformentioned fields.
...
Open clusters are coeval groups of stars and, when obeserved in period and mass space, two distinct populations of fast and slow rotators can be seen after $\approx 10$Myrs; before this, the stars have not had time to transition and the  stellar disc effects make it very difficult to paramterise and model.
